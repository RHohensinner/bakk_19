 ...
 * 
 */
@WebServiceClient(name = "TestWS", targetNamespace = "http://ikarus.me.org/", wsdlLocation = "http://localhost:8080/IkarusDBEngine/TestWS.java/TestWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTWS_QNAME = new QName("http://ikarus.me.org/", "TestWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/IkarusDBEngine/TestWS.java/TestWS?wsdl");
    ...
    public TestWS getTestWSPort() {
        return super.getPort(new QName("http://ikarus.me.org/", "TestWSPort"), TestWS.class);
    }
    ...
    public TestWS getTestWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ikarus.me.org/", "TestWSPort"), TestWS.class, features);
    }
